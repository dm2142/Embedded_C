...
int main(void)
{
	...
	while(1){
		...
		if( GPIO_ReadFromInputPin(GPIOC, GPIO_PIN_13) == RESET){
			...
			command_code = 0x51;
			I2C_MasterSendData(I2C3, &command_code, 1, 0x68, I2C_START_REPEAT_ENABLE);

			I2C_MasterReceiveData(I2C3, &len, 1, 0x68, I2C_START_REPEAT_ENABLE);

			command_code = 0x52;
			I2C_MasterSendData(I2C3, &command_code, 1, 0x68, I2C_START_REPEAT_ENABLE);

			I2C_MasterReceiveData(I2C3, (uint8_t*) RxBufferData, len, 0x68, I2C_START_REPEAT_DISABLE);
